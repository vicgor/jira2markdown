...
class ListIndent(Token):
    ...
    # pyparsing 3.x: no public snake_case alias for parseImpl exists.
    # camelCase is the only correct override point for Token subclasses.
    def parseImpl(self, instring: str, loc: int, doActions: bool = True) -> tuple[int, Any]:  # noqa: N802
        exprs = []
